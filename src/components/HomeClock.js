            ...
            <div className={homeClockStyles.container}>
                <header className={homeClockStyles.pageHeader}>
                    ...
                    {/* Base code used for mouse scroll animation @ https://codepen.io/MichaelVanDenBerg/pen/POaPNe */}
                        ...
                        <svg className={homeClockStyles.mouseScrollAnimation} width="40px" height="100%" viewBox="0 0 247 390" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" style={{fillRule: `evenodd`, clipRule: `evenodd`, strokeLinecap: `round`, strokeLineJoin: `round`, strokeMiterlimit: `1.5`, position: `absolute`, top: `12.5vh`, zIndex: `2`}}>
                            <a href="/#worldClocks">
